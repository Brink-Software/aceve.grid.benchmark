(module
 ...
 (global $assembly/data-generator/seed (mut i32) (i32.const 12345))
 ...
 (data $10 (i32.const 1536) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\1a")
 (export "generateEmployeeData" (func $assembly/data-generator/generateEmployeeData))
 ...
 (func $~lib/rt/itcms/Object#makeGray (param $0 i32)
  ...
  block $__inlined_func$~lib/rt/itcms/Object#unlink$58
   local.get $0
   call $~lib/rt/itcms/Object#get:next
   local.tee $1
   i32.eqz
   if
    ...
    br $__inlined_func$~lib/rt/itcms/Object#unlink$58
   end
   local.get $0
   i32.load offset=8
   local.tee $2
 ...
 (func $assembly/data-generator/random (result f64)
  global.get $assembly/data-generator/seed
  ...
  i32.and
  global.set $assembly/data-generator/seed
  global.get $assembly/data-generator/seed
  f64.convert_i32_s
  f64.const 2147483647
  f64.div
 )
 (func $assembly/data-generator/randomRange (param $0 f64) (param $1 f64) (result f64)
  local.get $0
  call $assembly/data-generator/random
  local.get $1
  local.get $0
  f64.sub
  f64.mul
     ...
     block $~lib/string/String
      block $~lib/arraybuffer/ArrayBuffer
       block $~lib/object/Object
        ...
        i32.sub
        i32.load
        br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/array/Array<f64> $invalid
       end
       return
      end
      return
 ...
 (func $~lib/array/ensureCapacity (param $0 i32) (param $1 i32)
  ...
  if
   ...
   local.get $0
   i32.store
   block $__inlined_func$~lib/rt/itcms/__renew$64
    i32.const 1073741820
    local.get $2
    i32.const 1
    i32.shl
    ...
    if
     ...
     local.get $2
     local.set $1
     br $__inlined_func$~lib/rt/itcms/__renew$64
    end
    local.get $3
    local.get $4
    i32.load offset=12
 ...
 (func $assembly/data-generator/generateEmployeeData (param $0 i32) (param $1 f64) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    f64.neg
    local.get $7
    call $assembly/data-generator/randomRange
    f64.add
